/**
 * @generated SignedSource<<f2ed85da8bdbc56834dc9b81c61d0d2c>>
...
export type FindAllRecipes_query$data = {
  ...
  readonly " $fragmentType": "FindAllRecipes_query";
};
export type FindAllRecipes_query$key = {
  readonly " $data"?: FindAllRecipes_query$data;
  readonly " $fragmentSpreads": FragmentRefs<"FindAllRecipes_query">;
};

import FindAllRecipesQuery_graphql from './FindAllRecipesQuery.graphql';
...
return {
  ...
  "metadata": {
    ...
    "refetch": {
      ...
      "operation": FindAllRecipesQuery_graphql
    }
  },
